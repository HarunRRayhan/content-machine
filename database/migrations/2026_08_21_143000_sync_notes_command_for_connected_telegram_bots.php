...
{
    /**
     * TelegramBotCommands::LIST gained /notes; re-syncs Telegram's "/"
     * menu for every already-connected bot so it shows up without
     * anyone needing to disconnect/reconnect. See
