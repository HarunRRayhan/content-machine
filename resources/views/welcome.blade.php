            ...
            <header class="flex items-center justify-between border-b border-cm-border py-6">
                ...
                <nav class="flex items-center gap-5 text-sm">
                    <a
                        ...
                        class="text-cm-fg-muted transition hover:text-cm-fg"
                    >
                        GitHub
                    </a>
                    <a
            ...
            <main class="flex-1">
                ...
                <section class="cm-rise py-20 sm:py-28">
                    ...
                    <div class="mt-10 flex flex-wrap items-center gap-4">
                        <a
                            href="https://github.com/HarunRRayhan/content-machine"
                            class="rounded-sm bg-cm-accent px-6 py-3 text-sm font-semibold text-cm-bg transition hover:brightness-110"
                        >
                            View on GitHub
                        </a>
                        <a
